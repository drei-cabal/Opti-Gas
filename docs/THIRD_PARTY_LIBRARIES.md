...
| `haversine` | `libraries/python.txt` | Library-backed straight-line distance for radius filtering and OSM seed auditing. |
...
| `requests` | `libraries/python.txt` | Calls the OSRM routing API as the secondary live-route provider. |
